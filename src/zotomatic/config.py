...
_DEFAULT_CONFIG_TEMPLATE = "\n".join(
    [
        ...
        f"pending_loop_interval_seconds = {_render_value(_DEFAULT_SETTINGS['pending_loop_interval_seconds'])}",
        f"pending_max_attempts = {_render_value(_DEFAULT_SETTINGS['pending_max_attempts'])}",
